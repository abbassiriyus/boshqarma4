      ...
      <div>
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        ...
                        <div class="kilimanjaro_part m-top-15">
                            ...
                            <ul class="kilimanjaro_social_links">
                                <li><a href="#home"><i class="fa fa-facebook" aria-hidden="true"></i> Facebook</a></li>
                                <li><a href="#home"><i class="fa fa-twitter" aria-hidden="true"></i> Twitter</a></li>
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        ...
                        <div class="kilimanjaro_part m-top-15">
                            ...
                            <ul class="kilimanjaro_links">
                                <li><a href="#home"><i class="fa fa-angle-right" aria-hidden="true"></i>Terms & Conditions</a></li>
                                <li><a href="#home"><i class="fa fa-angle-right" aria-hidden="true"></i>About Licences</a></li>
                                <li><a href="#home"><i class="fa fa-angle-right" aria-hidden="true"></i>Help & Support</a></li>
                                <li><a href="#home"><i class="fa fa-angle-right" aria-hidden="true"></i>Careers</a></li>
                                <li><a href="#home"><i class="fa fa-angle-right" aria-hidden="true"></i>Privacy Policy</a></li>
                                <li><a href="#home"><i class="fa fa-angle-right" aria-hidden="true"></i>Community & Forum</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="kilimanjaro_part">
                            ...
                            <div class="kilimanjaro_blog_area">
                                ...
                                <a href="#home">Your Blog Title Goes Here</a>
        ...
        <div class=" kilimanjaro_bottom_header_one section_padding_50 text-center">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <p>©IT Tower by <a href="#home">abbas<i class="fa fa-love"></i></a></p>
                    </div>
                </div>
            </div>
        </div>
